...
function createDisableDirectives(options) {
  const {
    commentToken, type, value, justification, ruleMapper,
  } = options;
  ...
  sourceCode.getInlineConfigNodes().filter((token) => token.type !== 'Shebang').forEach((comment) => {
    ...
    switch (directiveText) {
      ...
      case 'eslint-disable-line': {
        ...
        const options = {
          commentToken: comment, type: directiveType, value: directiveValue, justification: justificationPart, ruleMapper,
        };
...
function resolveParserOptions(parser, providedOptions, enabledEnvironments) {
  ...
  if (isModule) {
    /*
         ...
         */
    mergedParserOptions.ecmaFeatures = { ...mergedParserOptions.ecmaFeatures, globalReturn: false };
  }
...
class Linter {
  ...
  _verifyWithoutProcessors(textOrSourceCode, providedConfig, providedOptions) {
    ...
    const configuredRules = { ...config.rules, ...commentDirectives.configuredRules };
    let lintingProblems;
  ...
  _verifyWithFlatConfigArrayAndProcessor(textOrSourceCode, config, options, configForRecursive) {
    ...
    const filterCodeBlock = options.filterCodeBlock
  ...
  _verifyWithFlatConfigArrayAndWithoutProcessors(textOrSourceCode, providedConfig, providedOptions) {
    ...
    const configuredRules = { ...config.rules, ...mergedInlineConfig.rules };
    let lintingProblems;
