...
class RuleTester {
  ...
  run(ruleName, rule, test) {
    ...
    function runRuleForItem(item) {
      ...
      let code; let filename; let output; let beforeAST; let
        afterAST;
      ...
      // Verify the code.
      const {
        getComments, applyLanguageOptions, applyInlineConfig, finalize,
    ...
    function testValidTemplate(item) {
      ...
      assert.strictEqual(messages.length, 0, util.format(
    ...
    function testInvalidTemplate(item) {
      ...
      if (typeof item.errors === 'number') {
        ...
        assert.strictEqual(messages.length, item.errors, util.format(
        ...
        assert.strictEqual(messages.length, item.errors.length, util.format(
          'Should have %d error%s but had %d: %s',
          item.errors.length,
