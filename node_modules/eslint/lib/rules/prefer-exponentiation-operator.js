    ...
    function report(node) {
      context.report({
        ...
        fix(fixer) {
          ...
          const exponentReplacement = parenthesizeIfShould(exponentText, shouldParenthesizeExponent);
          const replacement = parenthesizeIfShould(`${baseReplacement}**${exponentReplacement}`, shouldParenthesizeAll);
