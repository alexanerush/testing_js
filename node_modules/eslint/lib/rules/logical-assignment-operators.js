...
module.exports = {
  ...
  create(context) {
    ...
    return {
      ...
      // foo = foo || bar
      "AssignmentExpression[operator='='][right.type='LogicalExpression']": function (assignment) {
      ...
      // foo || (foo = bar)
      'LogicalExpression[right.type="AssignmentExpression"][right.operator="="]': function (logical) {
