...
module.exports = {
  ...
  create(context) {
    ...
    function validate(node) {
        ...
        if (never || asNeeded && blockBody[0].type === 'ReturnStatement') {
          ...
          context.report({
            ...
            fix(fixer) {
              ...
              const commentsExist = sourceCode.commentsExistBetween(openingBrace, firstValueToken)
      ...
      } else if (always || (asNeeded && requireReturnForObjectLiteral && arrowBody.type === 'ObjectExpression')) {
        context.report({
          node,
          loc: arrowBody.loc,
